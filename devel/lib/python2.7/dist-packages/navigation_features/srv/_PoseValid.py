...
"""autogenerated by genpy from navigation_features/PoseValidRequest.msg. Do not edit."""
import sys
...
class PoseValidRequest(genpy.Message):
  _md5sum = "3f8930d968a3e84d471dff917bb1cdae"
  _type = "navigation_features/PoseValidRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseValidRequest, self).__init__(*args, **kwds)
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from navigation_features/PoseValidResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PoseValidResponse(genpy.Message):
  _md5sum = "6f6da3883749771fac40d6deb24a8c02"
  _type = "navigation_features/PoseValidResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool ok
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseValidResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.ok is None:
        self.ok = False
    else:
...
def _get_struct_B():
    ...
    return _struct_B
class PoseValid(object):
  _type          = 'navigation_features/PoseValid'
  _md5sum = '4821b1f643199b9b14db486b922422d9'
  _request_class  = PoseValidRequest
  _response_class = PoseValidResponse
