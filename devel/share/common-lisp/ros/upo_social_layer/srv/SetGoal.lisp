...
(cl:defmethod cl:initialize-instance :after ((m <SetGoal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGoal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name upo_social_layer-srv:<SetGoal-request> is deprecated: use upo_social_layer-srv:SetGoal-request instead.")))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <SetGoal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader upo_social_layer-srv:goal-val is deprecated.  Use upo_social_layer-srv:goal instead.")
  (goal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGoal-request>)))
  ...
  "upo_social_layer/SetGoalRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGoal-request)))
  "Returns string type for a service object of type 'SetGoal-request"
  "upo_social_layer/SetGoalRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetGoal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGoal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name upo_social_layer-srv:<SetGoal-response> is deprecated: use upo_social_layer-srv:SetGoal-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGoal-response>)))
  ...
  "upo_social_layer/SetGoalResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGoal-response)))
  "Returns string type for a service object of type 'SetGoal-response"
  "upo_social_layer/SetGoalResponse")
