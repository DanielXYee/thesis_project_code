...
#include <upo_nav_gan/ros/DataManagementRos.h>



upo_gan_ros::DataManagementRos::DataManagementRos(string dir) {
	data_dir_ = dir;
}

upo_gan_ros::DataManagementRos::~DataManagementRos() {
}


bool upo_gan_ros::DataManagementRos::loadData()
{
...
geometry_msgs::PoseStamped upo_gan_ros::DataManagementRos::mapDataExists(int i) {
...
geometry_msgs::PoseStamped upo_gan_ros::DataManagementRos::getRobotPose(int i)
{
