...
upo_gan_ros::PlanningRos::PlanningRos(string data_dir) : Planning()
{
	data_dir_ = data_dir;
...
upo_gan_ros::PlanningRos::PlanningRos(string data_dir, bool fcn) : Planning()
{
	fcn_ = fcn;
...
upo_gan_ros::PlanningRos::~PlanningRos()
{
	delete data_;
}


bool upo_gan_ros::PlanningRos::loadData() {
	return data_->loadData();
}


int upo_gan_ros::PlanningRos::getDataSize() {
	return data_->getDataSize();
}


void upo_gan_ros::PlanningRos::setScenario(int i)
{
...
void upo_gan_ros::PlanningRos::visualize_people(upo_msgs::PersonPoseArrayUPO peop)
{
...
void upo_gan_ros::PlanningRos::visualize_demo_path(vector<geometry_msgs::PoseStamped> path)
{
...
vector<float> upo_gan_ros::PlanningRos::makePlanAndCount(int i, int planner_type)
{
...
vector<geometry_msgs::PoseStamped> upo_gan_ros::PlanningRos::makePlan(int i, int planner_type)
{
	vector<geometry_msgs::PoseStamped> path;
...
vector<float> upo_gan_ros::PlanningRos::getFeatureCountDemoPath(int i)
{
...
vector<float> upo_gan_ros::PlanningRos::getFeatureCountPath(vector<geometry_msgs::PoseStamped>* mypath)
{
	vector<float> demo_fc;
	//Calcule the feature count of the path
	navigation_features::GetFeatureCount gfc;
...
vector< vector<float> > upo_gan_ros::PlanningRos::calculateFeatureCountDemos(int type)
{
...
void upo_gan_ros::PlanningRos::setWeights(vector<float> w)
{
...
vector<float> upo_gan_ros::PlanningRos::initializeWeights(bool random, bool normalize)
{
...
void upo_gan_ros::PlanningRos::enableLossFunction(bool e, int i) 
{
...
void upo_gan_ros::PlanningRos::publish_robot_position(int i)
{
...
geometry_msgs::PoseStamped upo_gan_ros::PlanningRos::transformPoseTo(geometry_msgs::PoseStamped pose_in, string frame_out, bool usetime)
{
...
bool upo_gan_ros::PlanningRos::isQuaternionValid( geometry_msgs::Quaternion q){
 ...
 */
std::vector<geometry_msgs::PoseStamped> upo_gan_ros::PlanningRos::pathAdaptation(std::vector<geometry_msgs::PoseStamped> path)
{
